...
func main() {
	...
	if options.encryption != "" {
		...
		encryptedShellcode, encryptedLength, key := Encryptors.DetectEncryption(options.encryption, rawShellcode, options.key)
		...
		if options.guide {
			Decryptors.DecryptorsTemplates(foundLanguage, options.encryption, options.variable, options.key, encryptedLength, encryptedShellcode, key)
		}
